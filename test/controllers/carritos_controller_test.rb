...
class CarritosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrito" do
    assert_difference('Carrito.count') do
      post carritos_url, params: { carrito: { cantidad_productos: @carrito.cantidad_productos } }
    end
  ...
  test "should update carrito" do
    patch carrito_url(@carrito), params: { carrito: { cantidad_productos: @carrito.cantidad_productos } }
