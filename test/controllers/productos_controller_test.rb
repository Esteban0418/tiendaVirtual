...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { color: @producto.color, descripcion: @producto.descripcion, dimenciones: @producto.dimenciones, material: @producto.material, nombre: @producto.nombre, peso: @producto.peso, tipo: @producto.tipo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { color: @producto.color, descripcion: @producto.descripcion, dimenciones: @producto.dimenciones, material: @producto.material, nombre: @producto.nombre, peso: @producto.peso, tipo: @producto.tipo } }
